...
public class PowerUsageSummary extends PowerUsageBase implements OnLongClickListener,
    ...
    protected void refreshUi(@BatteryUpdateType int refreshType) {
        ...
        mBatteryTemp.setSubtitle(
                com.android.internal.util.vortex.VortexUtils.mccCheck(getContext()) ?
                com.android.internal.util.vortex.VortexUtils.batteryTemperature(getContext(), true) + "°F" :
                com.android.internal.util.vortex.VortexUtils.batteryTemperature(getContext(), false) + "°C");
    }
